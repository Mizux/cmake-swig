...
void
FooBar::setBarInt(int input) {
	_bar.setInt(input);
}

void
FooBar::setFooInt(int input) {
	_foo.setInt(input);
}

int64_t
FooBar::getInt64() const {
	return _bar.getInt64() + _foo.getInt64();
}

void
FooBar::setBarInt64(int64_t input) {
	_bar.setInt64(input);
}

void
FooBar::setFooInt64(int64_t input) {
	_foo.setInt64(input);
}

std::string
FooBar::operator()() const {
